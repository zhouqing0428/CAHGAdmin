...
<html>
  ...
  <h4 class="text-primary" align="center">操作规则:${deptName }</h4>
	<div v-show="showList">
		<div class="grid-btn">
		<!-- 	#if($shiro.hasPermission("sysdeptworkstandard:save")) -->
			<a class="btn btn-primary" @click="add"><i class="fa fa-plus"></i>&nbsp;新增</a>
			<!-- #end
			#if($shiro.hasPermission("sysdeptworkstandard:update")) -->
			<a class="btn btn-primary" @click="update"><i class="fa fa-pencil-square-o"></i>&nbsp;修改</a>
			<!-- #end
			#if($shiro.hasPermission("sysdeptworkstandard:delete")) -->
    ...
    <div v-show="!showList" class="panel panel-default">
		...
		<form class="form-horizontal">
			   	...
			   	<div class="col-sm-10">
			      <input type="text" class="form-control" v-model="sysDeptWorkStandard.title" placeholder="标题"/>
			    </div>
			</div>
									<!-- <div class="form-group">
			   	<div class="col-sm-2 control-label"></div>
			   	<div class="col-sm-10">
			      <input type="text" class="form-control" v-model="sysDeptWorkStandard.fileName" placeholder=""/>
			    </div>
			</div> -->
									<!-- <div class="form-group">
			   	<div class="col-sm-2 control-label">附件名称</div>
			   	<div class="col-sm-10">
			      <input type="text" class="form-control" v-model="sysDeptWorkStandard.fileOldName" placeholder="附件名称"/>
			    </div>
			</div> -->
			...
			<div class="form-group">
			   	...
			   	<div class="col-sm-2 control-label"></div>
			   	<div class="col-sm-10">
			      <input type="text" class="form-control" v-model="sysDeptWorkStandard.deptId" placeholder=""/>
			    </div>
			</div> -->
							<div class="form-group">
				<div class="col-sm-2 control-label"></div> 
...
<script src="<%=basePath %>/js/oa/sysdeptworkstandard.js?_${date.systemTime}"></script>
  </body>
</html>
